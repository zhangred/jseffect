    ...
    bindTarget:function(){
        ...
        this.btn_sure.addEventListener('click',function(){
            if(typeof(that.v[that.fieldvalue])!='undefined'){
                that.opts.confirm&&that.opts.confirm(that.v,that.tag,function(){
                    that.value = that.v;
                    that.pop.classList.remove('cm-pop-active');
                });
            }
...
overtouch.prototype = {
    ...
    bindevent:function(){
        ...
        elm.addEventListener('touchend',function(event){
            ...
            ltouch.pageY = lbc.top<edge?edge:(lbc.bottom+edge>wdh?wdh-edge-lbc.height:lbc.top);
